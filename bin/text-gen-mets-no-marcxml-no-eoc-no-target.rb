#------------------------------------------------------------------------------
# Time-stamp: <2019-03-20 14:09:17 jgp>
#------------------------------------------------------------------------------
#
# NOTE: THIS CODE DOES ***NOT*** REQUIRE THAT AN EOC    FILE IS PRESENT
# NOTE: THIS CODE DOES ***NOT*** REQUIRE THAT AN TARGET FILE IS PRESENT
#
...
def emit_struct_map_inner_div_open
  puts %(        <div TYPE="INTELLECTUAL_ENTITY" ID="s-ie-00000001" DMDID="dmd-00000001" ADMID="rmd-00000001">)
end
...
def get_md_file_inventory(dir)
  ...
  result = Dir.glob(File.join(dir, "*_marcxml.xml"))
  if result.length != 0
    errors << "MARCXML FILE DETECTED. THIS SCRIPT IS FOR DIRS W/O MARCXML FILES\n"
  end
