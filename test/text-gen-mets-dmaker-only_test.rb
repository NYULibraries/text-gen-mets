...
class TestTextGenMetsDmakerOnly < MiniTest::Test

  COMMAND = 'ruby bin/text-gen-mets-dmaker-only.rb'

  VALID_TEXT          = 'test/fixtures/texts/dmaker-only'
  EMPTY_TEXT          = 'test/fixtures/texts/empty-dir'
  DMAKER_ONLY_TEXT    = 'test/fixtures/texts/dmaker-only'
  CANONICAL_DMAKER_ONLY_XML = 'test/fixtures/canonical/valid_mets-dmaker-only.xml'
